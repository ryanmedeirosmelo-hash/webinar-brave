...
export const registrationSchema = z.object({
  ...
  // Minúsculas: a busca por inscrição existente compara e-mail com `=`, e o
  // teclado do iPhone capitaliza a primeira letra por padrão. Sem normalizar,
  // "Maria@gmail.com" e "maria@gmail.com" viram duas pessoas diferentes.
